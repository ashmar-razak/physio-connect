    ...
    data: {
      ...
      physioProfile: {
        create: {
          ...
          hasInsurance: true,
          insurer: "Balens",
          insurancePolicyNumber: "BAL-88213",
          insuranceExpiryDate: new Date("2027-04-01"),
          insuranceCoversPitchside: "YES",
          yearsExperience: 6,
          dayRate: 180,
    ...
    data: {
      ...
      physioProfile: {
        create: {
          ...
          hasInsurance: true,
          insurer: "Howden",
          insurancePolicyNumber: "HOW-44921",
          insuranceCoversPitchside: "NOT_SURE",
          yearsExperience: 9,
          dayRate: 220,
          sports: "rugby,hockey",
          certifications: {
